...
void sendData (void) {
    ...
    buffer->motor3_rpm_pcm = 0;
    buffer->motor4_rpm_pcm = 0;
    ESP_LOGI(TAG, "x-axis: %x", (uint8_t)buffer->x_axis);
    ESP_LOGI(TAG, "y-axis: %x", (uint8_t)buffer->y_axis);
    ESP_LOGI(TAG, "pcm 1: %x", (uint8_t)buffer->motor1_rpm_pcm);
    ESP_LOGI(TAG, "pcm 2: %x", (uint8_t)buffer->motor2_rpm_pcm);
    ESP_LOGI(TAG, "pcm 3: %x", (uint8_t)buffer->motor3_rpm_pcm);
    ESP_LOGI(TAG, "pcm 4: %x", (uint8_t)buffer->motor4_rpm_pcm);
