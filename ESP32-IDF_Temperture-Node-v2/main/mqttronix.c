...
static void mqtt_publish_task(void *arg) {
    ...
    while (1) {
        esp_mqtt_client_publish(mqtt_client, "nodes/indoors/foxie4/sensors/temperature", temp_str, 0, 1, 0);
        esp_mqtt_client_publish(mqtt_client, "nodes/indoors/foxie4/sensors/humidity", humidity_str, 0, 1, 0);
        esp_mqtt_client_publish(mqtt_client, "nodes/indoors/foxie4/sensors/pressure", pressure_str, 0, 1, 0);
