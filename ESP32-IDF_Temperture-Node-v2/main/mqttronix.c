...
static void mqtt_publish_task(void *arg) {
    ...
    while (1) {
        esp_mqtt_client_publish(mqtt_client, "nodes/indoors/foxie3/sensors/temperature", temp_str, 0, 1, 0);
        ...
        ESP_LOGI(MQTT_TAG, "Called task to publish topic \"nodes/indoors/foxie3/#\"");
    }
}
