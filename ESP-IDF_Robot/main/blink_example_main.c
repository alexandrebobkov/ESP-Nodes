...
#define MTR_FRONT_LEFT_REV_IO       (2)
#define MTR_FRONT_LEFT_REV_TMR      LEDC_TIMER_0
#define MTR_FRONT_LEFT_REV          LEDC_CHANNEL_1
#define MTR_FRONT_LEFT_REV_DUTY     (3361)
// RIGHT SIDE MOTORS, REVERSE
#define MTR_FRONT_RIGHT_REV_IO      (3)
#define MTR_FRONT_RIGHT_REV_TMR     LEDC_TIMER_1
#define MTR_FRONT_RIGHT_REV         LEDC_CHANNEL_0
