...
#define LEDC_DUTY               (2000) // Set duty to 50%. (2 ** 13) * 50% = 4096 1024
#define LEDC_FREQUENCY          (2000) // For LED the freuqncy of 500Hz seemed to be sufficient. // Frequency in Hertz. For DC motor, set frequency at 5 kHz
