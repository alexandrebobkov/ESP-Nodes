...
#define MTR_DUTY_RES                LEDC_TIMER_13_BIT       // 13-bit resolution supports the range
...
#define LEDC_FREQUENCY              (5000) //8192) //4000) // For LED the freuqncy of 500Hz seems to be sufficient. // Frequency in Hertz. For DC motor, set frequency at 5 kHz; try 1kHz @ 14 bits resolution
