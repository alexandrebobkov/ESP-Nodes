__component_set_property(___idf_main REQUIRES "esp_wifi;esp_netif;nvs_flash;motors;adc;wifi_sys;mqtt_sys;espnow_sys;sensors;controls;ui;i2c_bus")
__component_set_property(___idf_main PRIV_REQUIRES "esp-idf-lib__i2cdev;esp-idf-lib__ina219;esp-idf-lib__ultrasonic")
...
__component_set_property(___idf_main MANAGED_PRIV_REQUIRES "esp-idf-lib__i2cdev;esp-idf-lib__ina219;esp-idf-lib__ultrasonic")
__component_set_property(___idf_wifi_sys REQUIRES "esp_wifi;esp_netif")
__component_set_property(___idf_wifi_sys PRIV_REQUIRES "")
__component_set_property(___idf_wifi_sys __COMPONENT_REGISTERED 1)
__component_set_property(___idf_wifi_sys INCLUDE_DIRS ".")
__component_set_property(___idf_wifi_sys __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_mqtt_sys REQUIRES "mqtt")
__component_set_property(___idf_mqtt_sys PRIV_REQUIRES "")
__component_set_property(___idf_mqtt_sys __COMPONENT_REGISTERED 1)
__component_set_property(___idf_mqtt_sys INCLUDE_DIRS ".")
__component_set_property(___idf_mqtt_sys __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_espnow_sys REQUIRES "esp_wifi")
__component_set_property(___idf_espnow_sys PRIV_REQUIRES "")
__component_set_property(___idf_espnow_sys __COMPONENT_REGISTERED 1)
__component_set_property(___idf_espnow_sys INCLUDE_DIRS ".")
__component_set_property(___idf_espnow_sys __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_motors REQUIRES "esp_driver_ledc;esp_driver_gpio")
__component_set_property(___idf_motors PRIV_REQUIRES "")
__component_set_property(___idf_motors __COMPONENT_REGISTERED 1)
__component_set_property(___idf_motors INCLUDE_DIRS ".")
__component_set_property(___idf_motors __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_adc REQUIRES "esp_adc")
__component_set_property(___idf_adc PRIV_REQUIRES "")
__component_set_property(___idf_adc __COMPONENT_REGISTERED 1)
__component_set_property(___idf_adc INCLUDE_DIRS ".")
__component_set_property(___idf_adc __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_sensors REQUIRES "driver;esp_adc;i2c_bus")
__component_set_property(___idf_sensors PRIV_REQUIRES "i2c_bus;esp-idf-lib__ina219;esp-idf-lib__i2cdev")
__component_set_property(___idf_sensors __COMPONENT_REGISTERED 1)
__component_set_property(___idf_sensors INCLUDE_DIRS ".")
__component_set_property(___idf_sensors __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_controls REQUIRES "freertos")
__component_set_property(___idf_controls PRIV_REQUIRES "")
__component_set_property(___idf_controls __COMPONENT_REGISTERED 1)
__component_set_property(___idf_controls INCLUDE_DIRS ".")
__component_set_property(___idf_controls __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_ui REQUIRES "freertos;esp_driver_gpio")
__component_set_property(___idf_ui PRIV_REQUIRES "")
__component_set_property(___idf_ui __COMPONENT_REGISTERED 1)
__component_set_property(___idf_ui INCLUDE_DIRS ".")
__component_set_property(___idf_ui __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_i2c_bus REQUIRES "driver;esp_driver_i2c")
__component_set_property(___idf_i2c_bus PRIV_REQUIRES "")
__component_set_property(___idf_i2c_bus __COMPONENT_REGISTERED 1)
__component_set_property(___idf_i2c_bus INCLUDE_DIRS ".")
__component_set_property(___idf_i2c_bus __COMPONENT_SOURCE "project_extra_components")
__component_set_property(___idf_esp-idf-lib__esp_idf_lib_helpers REQUIRES "freertos")
__component_set_property(___idf_esp-idf-lib__esp_idf_lib_helpers PRIV_REQUIRES "")
__component_set_property(___idf_esp-idf-lib__esp_idf_lib_helpers __COMPONENT_REGISTERED 1)
__component_set_property(___idf_esp-idf-lib__esp_idf_lib_helpers INCLUDE_DIRS ".")
__component_set_property(___idf_esp-idf-lib__esp_idf_lib_helpers __COMPONENT_SOURCE "project_managed_components")
__component_set_property(___idf_esp-idf-lib__i2cdev REQUIRES "esp_driver_gpio;esp_driver_i2c;freertos;esp-idf-lib__esp_idf_lib_helpers")
__component_set_property(___idf_esp-idf-lib__i2cdev PRIV_REQUIRES "esp-idf-lib__esp_idf_lib_helpers")
__component_set_property(___idf_esp-idf-lib__i2cdev __COMPONENT_REGISTERED 1)
__component_set_property(___idf_esp-idf-lib__i2cdev INCLUDE_DIRS ".")
__component_set_property(___idf_esp-idf-lib__i2cdev __COMPONENT_SOURCE "project_managed_components")
__component_set_property(___idf_esp-idf-lib__i2cdev MANAGED_PRIV_REQUIRES "esp-idf-lib__esp_idf_lib_helpers")
__component_set_property(___idf_esp-idf-lib__ina219 REQUIRES "esp-idf-lib__i2cdev;log;esp-idf-lib__esp_idf_lib_helpers")
__component_set_property(___idf_esp-idf-lib__ina219 PRIV_REQUIRES "esp-idf-lib__esp_idf_lib_helpers;esp-idf-lib__i2cdev")
__component_set_property(___idf_esp-idf-lib__ina219 __COMPONENT_REGISTERED 1)
__component_set_property(___idf_esp-idf-lib__ina219 INCLUDE_DIRS ".")
__component_set_property(___idf_esp-idf-lib__ina219 __COMPONENT_SOURCE "project_managed_components")
__component_set_property(___idf_esp-idf-lib__ina219 MANAGED_PRIV_REQUIRES "esp-idf-lib__esp_idf_lib_helpers;esp-idf-lib__i2cdev")
__component_set_property(___idf_esp-idf-lib__ultrasonic REQUIRES "log;esp-idf-lib__esp_idf_lib_helpers;esp_timer;esp_driver_gpio")
__component_set_property(___idf_esp-idf-lib__ultrasonic PRIV_REQUIRES "esp-idf-lib__esp_idf_lib_helpers")
__component_set_property(___idf_esp-idf-lib__ultrasonic __COMPONENT_REGISTERED 1)
__component_set_property(___idf_esp-idf-lib__ultrasonic INCLUDE_DIRS ".")
__component_set_property(___idf_esp-idf-lib__ultrasonic __COMPONENT_SOURCE "project_managed_components")
__component_set_property(___idf_esp-idf-lib__ultrasonic MANAGED_PRIV_REQUIRES "esp-idf-lib__esp_idf_lib_helpers")
...
__component_set_property(___idf_console INCLUDE_DIRS "/home/alex/github/ESP-Nodes/ESP-IDF_NovaGlide/build")
...
__component_set_property(___idf_esp-tls INCLUDE_DIRS "/home/alex/github/ESP-Nodes/ESP-IDF_NovaGlide/build;esp-tls-crypto")
...
__component_set_property(___idf_mqtt INCLUDE_DIRS "/home/alex/esp/esp-idf/v5.4.1/components/mqtt/esp-mqtt/include")
__component_set_property(___idf_mqtt __COMPONENT_SOURCE "idf_components")
__component_set_property(___idf_mqtt KCONFIG "/home/alex/esp/esp-idf/v5.4.1/components/mqtt/esp-mqtt/Kconfig")
